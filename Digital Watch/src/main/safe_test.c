...
// volatile static uint8_t setup_click = 0;
// volatile static uint8_t setup_update = 0;
// volatile static uint8_t setup_increase = 0;
...
// volatile static uint16_t display_number = 0;
// volatile static uint8_t display_on = 0;
// // volatile static uint8_t display_check = 0;
...
// static inline void handleSetup(uint8_t* value);
...
// 	while((power_on) && (setup_flag)){

// 		if(setup_update && display_on){

// 			if(setup_increase){
// 				handleSetup(&setup_click);
// 			}
